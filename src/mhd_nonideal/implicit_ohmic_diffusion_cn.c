...
void update_B_and_Energy()
{
  ...
  for(i = 0; i < NumGas; i++)
    {
      double dEmag = -0.5 * (SphP[i].BConserved[0] * SphP[i].BConserved[0] + SphP[i].BConserved[1] * SphP[i].BConserved[1] + SphP[i].BConserved[2] * SphP[i].BConserved[2]);

      for(k = 0; k < 3; k++)
        SphP[i].BConserved[k] = SphP[i].B[k] * SphP[i].Volume;

      dEmag += 0.5 * (SphP[i].BConserved[0] * SphP[i].BConserved[0] + SphP[i].BConserved[1] * SphP[i].BConserved[1] + SphP[i].BConserved[2] * SphP[i].BConserved[2]);
