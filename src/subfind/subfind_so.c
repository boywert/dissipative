              ...
              if(Group[i].Nsubs > 0)
                {
                  ...
                  switch (rep)
                    {
                    case 0:
                      Right[i] = Left[i] = GroupCat[Group[i].GrNr].R_Mean200;
                      break;
                    case 1:
                      Right[i] = Left[i] = GroupCat[Group[i].GrNr].R_TopHat200;
                      break;
                    case 2:
                      Right[i] = Left[i] = GroupCat[Group[i].GrNr].R_Crit200;
                      break;
                    case 3:
                      Right[i] = Left[i] = GroupCat[Group[i].GrNr].R_Crit500;
                      break;
                    }
#else
                  if(mainstep == 0)
