 ...
 *     [SubTree_MaxPart... SubTree_MaxPart+SubTree_MaxNodes-1]  references tree nodes.
 *     [SubTree_MaxPart+SubTree_MaxNodes...  SubTree_MaxPart+SubTree_MaxNodes+NTopleaves-1]                                  references "pseudo particles", i.e. mark branches on foreign CPUs
 *     [SubTree_MaxPart+SubTree_MaxNodes+NTopleaves... SubTree_MaxPart+SubTree_MaxNodes+NTopleaves+0-1]   references imported points
 *
 *  `Nodes_base' points to the first tree node, while `Nodes' is shifted such that SubNodes[SubTree_MaxPart] gives the root tree node.
 */
