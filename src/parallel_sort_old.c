...
static void parallel_merge(int master, int ncpu, size_t * nlist, size_t nmax, char *base, size_t nmemb, size_t size, int (*compar) (const void *, const void *));
...
void parallel_merge(int master, int ncpu, size_t * nlist, size_t nmax, char *base, size_t nmemb, size_t size, int (*compar) (const void *, const void *))
{
  size_t na, nb, nr;
