...
sn = arepo.ICs("ics.hdf5", [N_x*N_y/2 + N_x*N_y*4/2,0,0,0,0,0], precision=np.float64)
...
sn.part0.pos[N_x*N_y/4:N_x*N_y/4+N_x*N_y*2,0] = posx2[N_x*N_y:N_x*N_y*3]
sn.part0.pos[N_x*N_y/4:N_x*N_y/4+N_x*N_y*2,1] = posy2[N_x*N_y:N_x*N_y*3]
sn.part0.mass[N_x*N_y/4:N_x*N_y/4+N_x*N_y*2] = 2.*dx*dy/4.
...
sn.part0.id[:] = np.arange(N_x*N_y/2 + N_x*N_y*4/2)+1
