...
#ADD_GROUP_PROPERTIES_REUSE_GROUPS  # This uses the existing snapshot and group catalogue also to determine particle membership to groups
...
#BH_CONSTANT_POWER_RADIOMODE_IN_ERG_PER_S=1.0e44
#BH_BONDI_DEFAULT          # default Bondi prescription
#BH_CONSTANT_POWER_RADIOMODE_IN_ERG_PER_S=1e44
##BH_CONSTANT_POWER_RADIOMODE_START_TIME_IN_MYR=100.0
#BH_CONSTANT_POWER_RADIOMODE_TIMELIMIT_IN_MYR=50.0
...
#BH_PRESSURE_CRITERION_USE_AS_RADIO_SWITCH
#BH_NEW_PRESSURE_CRITERION
...
#NETWORK_SCREENING
#REACLIB1
#NUCLEAR_NETWORK_LIMIT_ENERGY_GENERATION_PER_TIMESTEP
...
#GFM_DUST_SPUTTERING                    #sputtering of dust grains by gas-phase metals
...
#CRANK_NICOLSON                        # Crank Nicolson time discretization,  second order accurate, timestep needs to be limited by CFL
#UMC_CORRECTOR                         # Unifified Manifold Corrector, for faster convegence of picard iterations
